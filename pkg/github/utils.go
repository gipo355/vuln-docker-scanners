...
func (e *Client) GetUserInputFromEnv(name string) string {
...
func (e *Client) SetOutput(name, value string) error {
	path := e.Environment.GITHUB_OUTPUT
	if path == "" {
...
func (e *Client) SetState(content string) error {
	path := e.Environment.GITHUB_STATE
	if path == "" {
